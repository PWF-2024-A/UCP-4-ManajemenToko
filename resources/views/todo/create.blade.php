                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('todo.store') }}" class="">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="jumlah" name="jumlah" type="text" class="block w-full mt-1"
                                required autofocus autocomplete="jumlah" :value="old('jumlah')" />
                            ...
                            <x-select id="total_id" name="total_id" class="block w-full mt-1">
                                ...
                                @foreach ($totals as $total)
                                    <option value="{{ $total->id }}"
                                        {{ old('total_id') == $total->id ? 'selected' : '' }}>
                                        {{ $total->title }}
                                    </option>
                                @endforeach
                            </x-select>
